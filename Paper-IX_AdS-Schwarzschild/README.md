> ## ⚠️ Status: superseded
> Original note IX, kept for the record. Superseded by the consolidated treatment (which folds the AdS case into one generalisation section). See [`../ERRATA.md`](../ERRATA.md) and [`../consolidated/`](../consolidated/).
